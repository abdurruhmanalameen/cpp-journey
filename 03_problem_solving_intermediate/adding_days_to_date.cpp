...
stDate addingDaysToDate(int addedDays, int Year, int DateOrderInYear)
{
    stDate Date;
    ...
    while (true)
    {
        yearDays = numberOfDaysInYear(Year);
...
int main()
{
    ...
    Date = addingDaysToDate(orderOfTheDay, year, orderOfTheDay);
